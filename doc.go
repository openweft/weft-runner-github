...
// # TODO (rough order)
//
//  1. GitHub Actions runner registration via REST (POST /orgs/{org}/actions/runners/registration-token).
...
//  6. Log streaming back to the controlling weft-runner-github process and
//     thence to GitHub via the runtime API.
